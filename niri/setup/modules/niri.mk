...
install-systemd-unit.niri:  $(NIRI_WANTS_DIR)/noctalia.service $(NIRI_WANTS_DIR)/xrdb.service $(NIRI_WANTS_DIR)/neru.service

$(NIRI_WANTS_DIR)/noctalia.service: $(SYSTEMD_USER_DIR)/noctalia.service $(NIRI_WANTS_DIR)
	ln -sf $(SYSTEMD_USER_DIR)/noctalia.service $(NIRI_WANTS_DIR)/
$(NIRI_WANTS_DIR)/xrdb.service: $(SYSTEMD_USER_DIR)/xrdb.service $(NIRI_WANTS_DIR)
	ln -sf $(SYSTEMD_USER_DIR)/xrdb.service $(NIRI_WANTS_DIR)/
$(NIRI_WANTS_DIR)/neru.service: $(SYSTEMD_USER_DIR)/neru.service $(NIRI_WANTS_DIR)
	ln -sf $(SYSTEMD_USER_DIR)/neru.service $(NIRI_WANTS_DIR)/
